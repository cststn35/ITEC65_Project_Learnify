...
function renderTasks(data){
    ...
    data.forEach(task=>{
        ...
        const targetTime = task.estimated_seconds==null ? 0: task.estimated_seconds / 60;
        ...
        taskContainer.innerHTML += `
    <div
        class="one-card bg-white border border-slate-200 shadow-sm w-full rounded-lg mx-auto p-4 sm:p-6 flex flex-col gap-3 data-task-id=${taskID}">
