...
//js for adding schedule
const scheduleForm = document.getElementById("schedule-form");
scheduleForm.addEventListener("submit", submitCreatedSchedule);
...
async function submitCreatedSchedule(e) {
  ...
  if (result.isConfirmed) {
    ...
    const response = await fetch(
      `/${BASE_URL}/actions/dashboard/create_schedule.php?userID=${userID}&semesterID=${semesterID}`,
      {
        method: "POST",
        body: formData,
      },
